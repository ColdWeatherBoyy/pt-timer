...
const DeletableListItem: React.FC<DeletableListItemProps> = ({
	...
	return (
		<div className="flex relative items-start text-jade-100 text-md text-nowrap bg-gradient-to-r from-jade-600 to-jade-900 py-2.5 px-5 mx-1.5 rounded-lg shadow-lg">
			{text}
			<div
